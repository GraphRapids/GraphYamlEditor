  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const message = err instanceof Error && err.message ? err.message : "Profile catalog is temporarily unavailable.";
...
function GraphYamlEditor({
  ...
  const internalProfileCatalogCacheRef = useRef(/* @__PURE__ */ new Map());
...
${" ".repeat(nextIndent)}`
  ...
  return /* @__PURE__ */ jsxs("div", { className: "editor-shell", "aria-label": "YAML editor", style: DEFAULT_EDITOR_SHELL_STYLE, children: [
    profileCatalogWarning ? /* @__PURE__ */ jsx(
      "div",
      {
        role: "status",
        ...
        children: profileCatalogWarning
      }
    ) : null,
    /* @__PURE__ */ jsx(
      Editor,
